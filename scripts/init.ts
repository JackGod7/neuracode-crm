...
/**
 * Neuracode CRM initialization script.
...
console.log("Initializing Neuracode CRM...");
...
const defaultConfigPath = path.join(process.cwd(), "scripts", "crm-config.default.json");
...
console.log("\nNeuracode CRM initialized successfully!");
